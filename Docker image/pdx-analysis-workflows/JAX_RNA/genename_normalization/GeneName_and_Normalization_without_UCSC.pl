...
open(FILEOUTGENEName, ">gene.withGeneName") || die "cannot open the file";
open(FILEOUTGENENorm, ">gene.Normalized") || die "cannot open the file";
...
open(FILEOUTISOName, ">isoform.withGeneName") || die "cannot open the file";
open(FILEOUTISONorm, ">isoform.Normalized") || die "cannot open the file";
